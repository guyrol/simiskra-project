...
//    ///////////////////////////////////////////////////////////////////////////////
//    //Sintetiza a sintax SQL a ser utilizada no  preparedStatement de cadastro
//    public void salvaCadastro(DadosCadastroCliente dadosCliente){
//
//        String sql = "INSET INTO usuarios (nome, email, senha)" + "VALUES (?, ?, ?)"; //sintax de Cadastro de usuario
//
//        try {
//            PreparedStatement preparedStatement = conn.prepareStatement(sql);
//
//            preparedStatement.setString(1, dadosCliente.nome());
//            preparedStatement.setString(2, dadosCliente.login());
//            preparedStatement.setString(3, dadosCliente.senha());
...
//    }
//
//    public void verificaLogin(DadosCadastroCliente dadosCliente){
//
//        String sql = "SELECT * FROM usuarios WHERE email = ? AND senha = ?";
//
//        try {
//            PreparedStatement preparedStatement = conn.prepareStatement(sql);
//
//            preparedStatement.setString(1, dadosCliente.login());
//            preparedStatement.setString(2, dadosCliente.senha());
//            preparedStatement.execute();
//
